...
namespace BlueGraphSamples
{
    ...
    public abstract class ExecutableNode : Node, ICanExecute
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual ICanExecute Execute(ExecutionFlowData data)
        {
            // noop.
        ...
        /// </summary>
        /// <returns></returns>
        public ICanExecute GetNextExecutableNode(string portName = "ExecOut")
        {
            ...
            if (node is ICanExecute execNode)
            {
                return execNode;
            }
