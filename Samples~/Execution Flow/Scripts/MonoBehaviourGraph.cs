...
namespace BlueGraphSamples
{
    ...
    [IncludeTags("Math", "Executable", "Flow Control", "MonoBehaviour Events")]
    public class MonoBehaviourGraph : Graph, ICanExecuteSubtree
    { 
        ...
        {
            ExecuteSubtree(GetNode<OnEnable>(), new ExecutionFlowData {
        ...
        {
            ExecuteSubtree(GetNode<OnDisable>(), new ExecutionFlowData {
                // Whatever your data looks like
            });
        }
        ...
        public void OnBehaviourStart()
        {
            ...
            ExecuteSubtree(GetNode<OnStart>(), new ExecutionFlowData {
                // Whatever your data looks like
            });
        }
        ...
        {
            ExecuteSubtree(onUpdateNode, new ExecutionFlowData {
                // Whatever your data looks like
            });
        }
        ...
        /// </summary>
        public void ExecuteSubtree(ICanExecute root, ExecutionFlowData data)
        {
